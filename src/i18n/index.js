...
const messages = {
  "zh-CN": {
    ...
    notificationsPage: {
      ...
      noExtraConfigSidebar:
        "侧栏类型暂未提供额外配置，可以正常添加与管理消息。",
  ...
  en: {
    ...
    notificationsPage: {
      ...
      autoCloseHint:
        "When auto close is enabled, notification hides after a period.",
      noExtraConfigSidebar:
        "Sidebar type has no extra settings yet; you can add/manage messages.",
      noExtraConfigModal:
        "Modal type has no extra settings yet; you can add/manage messages.",
